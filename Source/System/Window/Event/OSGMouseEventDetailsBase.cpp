...
PointerType FieldTraits<MouseEventDetails *, nsOSG>::_type(
    "MouseEventDetailsPtr", 
    "InputEventDetailsPtr", 
    MouseEventDetails::getClassType(),
    nsOSG);
#endif

OSG_FIELDTRAITS_GETTYPE_NS(MouseEventDetails *, nsOSG)
