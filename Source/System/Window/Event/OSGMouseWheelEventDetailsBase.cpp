...
PointerType FieldTraits<MouseWheelEventDetails *, nsOSG>::_type(
    "MouseWheelEventDetailsPtr", 
    "InputEventDetailsPtr", 
    MouseWheelEventDetails::getClassType(),
    nsOSG);
#endif

OSG_FIELDTRAITS_GETTYPE_NS(MouseWheelEventDetails *, nsOSG)
